  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAProduct.fulfilled, (state, action) => {
        ...
        state.productCodTrans = action.payload.codigoTransmissao;
        state.productGarantia = action.payload.garantia;
        state.productTag = action.payload.tags;
        state.productApplications = action.payload.application;
